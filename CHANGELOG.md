...
### 2026-09-19 — `release/v1.5.0`

- `1.5.0-beta.2`에서 정식 `1.5.0`으로 승격하고 MCP initialize 서버 버전을 갱신했습니다.
- 메신저 채널 목록·생성, 멤버 참여·퇴장, 채널 메시지 전송·수정·삭제·답글, 스레드 생성 기능을 포함합니다.
- 검증: 릴리스 브랜치에서 전체 단위 테스트·vet·race 검사·모듈 정합성 검사와 macOS·Linux·Windows 크로스 빌드를 통과했습니다.
